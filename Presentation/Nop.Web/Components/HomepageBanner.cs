...
{
    public class HomepageBannerViewComponent : NopViewComponent
    {
        ...
        public HomepageBannerViewComponent(ICacheKeyService cacheKeyService,
        ...
        public IViewComponentResult Invoke()
        {
            ...
            var model = new NivoSliderPublicInfoModel
            {
