...
namespace Nop.Web.Controllers
{
    public partial class CatalogController : BasePublicController
    {
        ...
        public virtual IActionResult Category(int categoryId, CatalogPagingFilteringModel command)
        {
            ...
            //自訂view
            return View("CategoryBooks", model);
        }

        public virtual IActionResult CategoryOriginal(int categoryId, CatalogPagingFilteringModel command)
        {
            var category = _categoryService.GetCategoryById(categoryId);
            if (category == null || category.Deleted)
                return InvokeHttp404();
        ...
        [HttpPost]
        public virtual IActionResult GetCategoryMenu(int categoryId)
        {
            
            var categoryMenuhtml = RenderViewComponentToString("CategoryMenu", new { currentCategoryId = categoryId, currentProductId = 0 });
